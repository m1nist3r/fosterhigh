    ...
    $('#fullpage').fullpage({
      ...
      onLeave: function(anchorLast, anchorFirst, direction) {
        if (anchorFirst.anchor == 'home') {
          ...
          $(doc)
            .find('.st1')
            .css({ fill: '#ffbf0a', transition: '1.0s' });
          ...
          $(doc)
            .find('.st1')
            .css({ fill: '#17e7c6', transition: '1.0s' });
          defaultIconColor(doc, iconSVG);
          ...
          $(doc)
            .find('.st1')
            .css({ fill: '#071566', transition: '1.0s' });
          ...
          $('.col-program-1').effect(
            ...
            function() {
              $('.col-program-3').effect(
                ...
                500,
                function() {
                  $('.col-program-5').effect(
                    'slide',
                    { direction: 'left', mode: 'hide' },
                    400,
                    function() {
                      $('.col-program-2').effect(
                        'slide',
                        { direction: 'down', mode: 'hide' },
                        400
                      );
      ...
      afterLoad: function(anchorLast, anchorFirst, direction) {
        ...
        if (anchorFirst.anchor == 'teachers') {
          $('.teacher-bg-prof').css('display', 'block');
          setTimeout(() => {
            changeTeachersBg();
          }, 500);
